      ...
      <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div class="mb-4">
          <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
            <h2 className="text-5xl text-center pb-24 text-black">
              Get in Touch
            </h2>
          </div>
        </div>
        <div class="flex items-stretch justify-center">
          <div class="grid md:grid-cols-2">
            <div class="h-full pr-6">
              <p class="mt-3 mb-12 text-lg tracking-wide">
              ...
              <ul class="mb-6 md:mb-0">
                <li class="flex">
                  ...
                  <div class="ml-4 mb-4">
                    <h3 class="mb-2 text-lg font-medium leading-6">
                      Our Address
                    </h3>
                    <p class=" ">Sohmor, Main Road</p>
                    <p class="">Lebanon</p>
                  </div>
                </li>
                <li class="flex">
                  ...
                  <div class="ml-4 mb-4">
                    <h3 class="mb-2 text-lg font-medium leading-6">Contact</h3>
                    <p class="">Mobile: +961 70609186</p>
                    <p class="">Mail: alimk03@gmail.com</p>
                  </div>
                </li>
                <li class="flex">
                  <div class="flex h-10 w-10 items-center justify-center rounded bg-black">
                  ...
                  <div class="ml-4 mb-4">
                    ...
                    <p class="">Monday - Friday: 09:00 - 22:00</p>
                    <p class="">Saturday &amp; Sunday: 09:00 - 20:00</p>
                  </div>
                </li>
              </ul>
            </div>
